          ...
          <Card>
            <div style={{ display: "grid", placeItems: "center", gap: 12, textAlign: "center" }}>
              ...
              <div className="row" style={{ gap: 6 }}>
                <Chip kind="accent">{form.role || 'Academic Supervisor'}</Chip>
        ...
        <div className="col">
          <Card label="Personal info">
            <div className="grid grid--2">
              ...
              <Field label="Title"><input name="title" placeholder="Dr. / Prof. / Mr. / Ms." /></Field>
            </div>
          </Card>
          ...
          <Card label="Academic appointment">
            <div className="grid grid--2">
              ...
              <Field label="Staff number"><input name="staff_number" placeholder="MAK/CS/001" /></Field>
