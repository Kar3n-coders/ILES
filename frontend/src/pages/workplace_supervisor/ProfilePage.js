...
export default function WorkplaceSupervisorProfilePage() {
  const [form, setForm] = useState({
    ...
    job_title: '', company: '', department: '', username: '',
    role: '',
  });
          ...
          <Card>
            <div style={{ display: "grid", placeItems: "center", gap: 12, textAlign: "center" }}>
              ...
              <div className="row" style={{ gap: 6 }}>
                <Chip kind="accent">{form.role || 'Workplace Supervisor'}</Chip>
        ...
        <div className="col">
          <Card label="Personal info">
            <div className="grid grid--2">
              ...
              <Field label="Job title"><input name="job_title" value={form.job_title} onChange={handleChange} /></Field>
            </div>
          </Card>

          <Card label="Organisation">
            <div className="grid grid--2">
              <Field label="Company name"><input name="company" value={form.company} onChange={handleChange} /></Field>
              <Field label="Department"><input name="department" value={form.department} onChange={handleChange} /></Field>
              <Field label="Office address"><input name="address" placeholder="City, Country" /></Field>
